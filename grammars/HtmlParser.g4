...
j_set_stmt
    : J_SET J_NAME J_ASSIGN j_expression JINJA_STMT_END # JinjaSetStmtDef
    ;

j_list_literal
    : J_LBRACK (j_atom (J_COMMA j_atom)*)? J_RBRACK # JinjaListLiteral
    ;

j_expression
    : j_call_expr ( J_EQ | J_NEQ | J_GT | J_LT ) j_call_expr # JinjaBinaryExpr
    | j_arithmetic_expr                                      # JinjaArithmeticExpression
    | j_call_expr # JinjaSimpleExpr
    ;

j_arithmetic_expr
    : j_call_expr J_PLUS  j_call_expr  # JinjaAddition
    | j_call_expr J_MINUS j_call_expr  # JinjaSubtraction
    | j_call_expr J_STAR  j_call_expr  # JinjaMultiplication
    | j_call_expr J_SLASH j_call_expr  # JinjaDivision
    ;
