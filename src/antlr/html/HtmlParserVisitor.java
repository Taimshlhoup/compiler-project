...
public interface HtmlParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitJinjaSetStmt(HtmlParser.JinjaSetStmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code JinjaSetStmtDef}
	 * labeled alternative in {@link HtmlParser#j_set_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJinjaSetStmtDef(HtmlParser.JinjaSetStmtDefContext ctx);
	/**
	 * Visit a parse tree produced by the {@code JinjaListLiteral}
	 * labeled alternative in {@link HtmlParser#j_list_literal}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJinjaListLiteral(HtmlParser.JinjaListLiteralContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code JinjaArithmeticExpression}
	 * labeled alternative in {@link HtmlParser#j_expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJinjaArithmeticExpression(HtmlParser.JinjaArithmeticExpressionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code JinjaAddition}
	 * labeled alternative in {@link HtmlParser#j_arithmetic_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJinjaAddition(HtmlParser.JinjaAdditionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code JinjaSubtraction}
	 * labeled alternative in {@link HtmlParser#j_arithmetic_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJinjaSubtraction(HtmlParser.JinjaSubtractionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code JinjaMultiplication}
	 * labeled alternative in {@link HtmlParser#j_arithmetic_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJinjaMultiplication(HtmlParser.JinjaMultiplicationContext ctx);
	/**
	 * Visit a parse tree produced by the {@code JinjaDivision}
	 * labeled alternative in {@link HtmlParser#j_arithmetic_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJinjaDivision(HtmlParser.JinjaDivisionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code JinjaListAtom}
	 * labeled alternative in {@link HtmlParser#j_atom}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJinjaListAtom(HtmlParser.JinjaListAtomContext ctx);
}